...
## IDE
Learn about IDE: https://www.redhat.com/en/topics/middleware/what-is-ide
IDE stands for “Integrated Development Environment”, and what it is, in simple terms, is the software for building applications that combines common developer tools into one place (specifically one GUI). An IDE commonly has 3 components: source code editor, local build automation, and debugger. Developers use IDE’s because they are super easy to use and to enter into a different world of syntax in a new programming language. 
